...
# 
# Source: [scikit learn](https://scikit-learn.org/stable/auto_examples/ensemble/plot_voting_regressor.html#sphx-glr-download-auto-examples-ensemble-plot-voting-regressor-py)
# 
...
# - `ensemble.RandomForestRegressor`, and
...
# prediction made by `~ensemble.VotingRegressor`.
