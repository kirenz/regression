...
# 
# 
# A generalized additive model (GAM) is a way to extend the multiple linear regression model {cite:p}`James2021`). Remember that the basic regression model can be stated as:
# 
